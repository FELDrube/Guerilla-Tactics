...
if ((count _list) != 1) exitWith {hint "No Workshop around!"; [_SUV, _id] remoteExec ["removeAction",0,true];};
...
if ([Fahr_geupgr, _SUVpathlong] call BIS_fnc_returnNestedElement) exitWith {		// wenn das panzerungs element schon auf true steht
	...
	[_SUV, _id] remoteExec ["removeAction",0,true];
	};
...
[_SUV, _id] remoteExec ["removeAction",0,true];
[_SUV, ["Launch smoke","vehicles\SUV\rauchwerfer.sqf"]] remoteExec ["addAction",0,true];
